...
int c=0; 
for(Laptop l:lap){ 
if(l.getbrand().equals(brand) && l.getrating()>3){ 
c++;}} 
return c; } 
public static ArrayList searchLaptopByOsType(Laptop[] lap,String ostype){ 
int maxi=-1;
ArrayListarr=new ArrayList<>();
//System.out.println("inside"+ostype); 
for(Laptop l:lap){
// System.out.println(l.getosType()); i
f(l.getosType().equalsIgnoreCase(ostype) ){ 
arr.add(l);
}}
if(arr.size()>0){ 
arr.sort((a,b)->b.getlaptopId()-a.getlaptopId());
return arr; } 
return null; }
public static void main(String args[]){ 
Scanner sc=new Scanner(System.in);
Laptop l[]=new Laptop[4]; 
for(int i=0;i o=searchLaptopByOsType(l,m); 
if(o==null){ 
